      ...
      <Container fixed>
        <Toolbar>
          ...
          <Box mr={3} className={classes.menuButton}>
            <Button color={"inherit"} variant={"outlined"} onClick={toggleModal} className={classes.buttonStyle}>Log
              in</Button>
          </Box>
          <Button color={"secondary"} variant={"contained"} onClick={() => handleButtonClick("/signup")}
                  className={classes.buttonStyle}>Sing up</Button>
        </Toolbar>
      </Container>
    </AppBar>
  )
